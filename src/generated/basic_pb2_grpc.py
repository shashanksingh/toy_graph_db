...
class ToyGraphDBStub(object):
    ...
    def __init__(self, channel):
        ...
        self.readGraph = channel.unary_unary(
                ...
                request_serializer=basic__pb2.ToyGraphDBRequest.SerializeToString,
                response_deserializer=basic__pb2.ToyGraphDBResponse.FromString,
                )
...
def add_ToyGraphDBServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'readGraph': grpc.unary_unary_rpc_method_handler(
                    servicer.readGraph,
                    request_deserializer=basic__pb2.ToyGraphDBRequest.FromString,
                    response_serializer=basic__pb2.ToyGraphDBResponse.SerializeToString,
            ),
...
class ToyGraphDB(object):
    ...
    def readGraph(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ToyGraphDB/readGraph',
            basic__pb2.ToyGraphDBRequest.SerializeToString,
            basic__pb2.ToyGraphDBResponse.FromString,
